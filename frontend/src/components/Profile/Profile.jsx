        ...
        <Navbar />
            <div className='flex flex-wrap items-center mx-auto justify-between max-w-screen-xl font-["Montserrat"] mt-16'>
                <div className='flex flex-col gap-4 font-medium text-md w-64 w-1/4 '>
                    <h1>Username:</h1>
                    <p className='border-[1px] border-black border-opacity-25 rounded-lg p-1 shadow-md'>{profile.username}</p>
                    <p>Email:</p>
                    <span className='border-[1px] border-black border-opacity-25 rounded-lg p-1 shadow-md'>{profile.email}</span>
                </div>
                <div className='w-3/4 flex flex-col justify-center items-center'>
                    <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 ">Assignments:</p>
                    <ul className='w-full mt-4 p-4 border-black border-opacity-10 border-[1px] rounded-3xl shadow-xl'>
                        {assignments.map(assignment => (
                            <li key={assignment.id} className='mt-2 border-black border-opacity-10 border-[1px] rounded-3xl p-4 shadow-md'>
